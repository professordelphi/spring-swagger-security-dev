...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 * "/**").permitAll() .antMatchers(HttpMethod.GET, "/**").hasRole("ADMIN")
		 ...
		 * whitelist Swagger UI resources // ... here goes your custom security
		 * configuration antMatchers("/**").authenticated(); // require authentication
		 * for any endpoint that's not whitelisted
		 */
		...
		System.out.println(" 71988640080 " + http.toString());
 ...
 * password("java123").roles("USER").build()); return manager; }
 * 
 * protected void configure(HttpSecurity http) throws Exception {
 * 
